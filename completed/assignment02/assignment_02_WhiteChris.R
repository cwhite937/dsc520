...
person_df2 <- read.csv(file = 'data/tidynomicon/person.csv', stringsAsFactors = TRUE)
str(person_df2)
...
voter_turnout_df1 <- read_excel('data/G04ResultsDetail2004-11-02.xls',2)
